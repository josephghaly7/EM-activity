...
const curriculum = [
  // ============ PHASE 1: FOUNDATION ============
  {
    ...
    days: [
      ...
      { day: 2, topic: "Vasopressors in shock", resource: "EM Cases", url: "https://www.youtube.com/watch?v=B9g5gNnpunk", duration: "15 min" },
      ...
      { day: 5, topic: "Post-cardiac arrest care", resource: "ALiEM", url: "https://www.youtube.com/watch?v=F-udw0Av4kw", duration: "15 min" },
      ...
      { day: 6, topic: "Airway skills workshop", resource: "YouTube: EMCrit, EM Core", url: "https://www.youtube.com/watch?v=iIdN1cDNzE0", duration: "30 min" },
  ...
  },
  {
    ...
    days: [
      ...
      { day: 15, topic: "Appendicitis imaging (CT, ultrasound)", resource: "EMLTW", url: "https://www.youtube.com/watch?v=AKi53i1ftCo", duration: "15 min" },
    ]
  },
  {
    ...
    days: [
      ...
      { day: 17, topic: "Dyspnea / shortness of breath — full approach", resource: "EM Cases", url: "https://www.youtube.com/watch?v=xNJ8ALMjZ7A", duration: "25 min" },
      { day: 17, topic: "Asthma & COPD exacerbation", resource: "ALiEM", url: "https://www.youtube.com/watch?v=CS3nFyut9RQ", duration: "15 min" },
      { day: 17, topic: "Congestive heart failure exacerbation", resource: "ALiEM", url: "https://www.youtube.com/watch?v=_n0AmpVE6lw", duration: "20 min" },
      { day: 18, topic: "Abdominal pain — adult", resource: "EM Cases", url: "https://www.youtube.com/watch?v=_PDOXlVGeuY", duration: "25 min" },
      { day: 18, topic: "Appendicitis, diverticulitis, pancreatitis", resource: "ALiEM", url: "https://www.youtube.com/watch?v=AKi53i1ftCo", duration: "25 min" },
      { day: 18, topic: "Mesenteric ischemia — high suspicion index", resource: "ALiEM", url: "https://www.youtube.com/watch?v=y5RwK0Nv-AI", duration: "15 min" },
      { day: 19, topic: "Headache — subarachnoid, meningitis, giant cell arteritis", resource: "EM Cases", url: "https://www.youtube.com/watch?v=2lGISy4mV5A", duration: "25 min" },
      { day: 19, topic: "CVA / stroke — tPA window, thrombectomy", resource: "ALiEM", url: "https://www.youtube.com/watch?v=BZMxkpr-X1M", duration: "20 min" },
      { day: 19, topic: "Seizures — status epilepticus", resource: "ALiEM", url: "https://www.youtube.com/watch?v=XBzGaINiqhc", duration: "15 min" },
  ...
  // ============ PHASE 2 ============
  {
    ...
    days: [
      ...
      { day: 22, topic: "Wide complex tachycardia", resource: "ALiEM", url: "https://www.youtube.com/watch?v=ZNZeNRQefVA", duration: "15 min" },
      { day: 22, topic: "Bradyarrhythmias & heart block", resource: "ALiEM", url: "https://www.youtube.com/watch?v=Hf6V6Q6dXsA", duration: "15 min" },
      { day: 23, topic: "Hypertensive emergency", resource: "ALiEM", url: "https://www.youtube.com/watch?v=B9g5gNnpunk", duration: "15 min" },
      ...
      { day: 24, topic: "Aortic dissection — full", resource: "EM Cases", url: "https://www.youtube.com/watch?v=KTDsi3TNe5A", duration: "25 min" },
  ...
  },
  {
    ...
    days: [
      { day: 32, topic: "CVA — full thrombolysis protocol", resource: "ALiEM", url: "https://www.youtube.com/watch?v=BZMxkpr-X1M", duration: "20 min" },
      { day: 32, topic: "Large vessel occlusion — thrombectomy", resource: "ALiEM", url: "https://www.youtube.com/watch?v=BZMxkpr-X1M", duration: "15 min" },
      { day: 32, topic: "Stroke mimics — seizures, migraine, functional", resource: "ALiEM", url: "https://www.youtube.com/watch?v=XBzGaINiqhc", duration: "15 min" },
      { day: 33, topic: "Subarachnoid hemorrhage — LP criteria, CTA", resource: "EM Cases", url: "https://www.youtube.com/watch?v=GOFHgD5uiU4", duration: "25 min" },
      ...
      { day: 34, topic: "Meningitis & encephalitis — empiric antibiotics", resource: "ALiEM", url: "https://www.youtube.com/watch?v=1kJjgtm1RAA", duration: "20 min" },
